        ...
        when (mailboxType){
            ...
            MailboxType.Spam -> 
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(
                            vertical = dimensionResource(id = R.dimen.detail_button_bar_padding_vertical)
                        ),
                    horizontalArrangement = Arrangement.spacedBy(
                        dimensionResource(id = R.dimen.detail_button_bar_item_spacing)
                    ),
                ){
                    ActionButton(
            ...
            MailboxType.Sent, MailboxType.Inbox ->
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(vertical = dimensionResource(id = R.dimen.detail_button_bar_padding_vertical)),
                    horizontalArrangement = Arrangement.spacedBy(
                        dimensionResource(id = R.dimen.detail_button_bar_item_spacing)
                    ),
                ) {
...
@Composable
private fun DetailsScreenHeader(email: Email, modifier: Modifier){
    Row(modifier = modifier){
        ReplyProfileImage(
            drawableResource = email.sender.avatar,
            description = email.sender.fullName,
            modifier = Modifier.size(
                dimensionResource(id = R.dimen.email_header_profile_size)
            )
        )
        Column(
            modifier = Modifier
